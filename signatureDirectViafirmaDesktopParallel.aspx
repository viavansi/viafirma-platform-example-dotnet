<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="signatureDirectViafirmaDesktopParallel.aspx.cs" Inherits="EjemploWebViafirmaClientDotNet.signatureDirectViafirmaDesktopParallel" %>
			...
			<div id="content">
				...
				<div class="group">
					<div class="col width-63 append-02">
						<div class="box">
							<h3 class="box-title">Firma múltiple con Viafirma Desktop</h3>
							<div class="box-content">
								<p>En este ejemplo se realiza la firma en paralelo de múltiples documentos, utilizando Javascript para la invocación a Viafirma Desktop por protocolo. Requiere código Javascript local.</p>
                                ...
                                <p id="signatureButton">
                                    <a class="button" href="<%=desktopInvocation.ViafirmaDesktopInvocationLink + "&isParallel=true"%>" onClick="initSignature();">Firmar con Viafirma Desktop</a>
                                </p>                                    
                                    <% }
                                    %>
                                </form>
					...
					<div class="col width-35">
						<div class="box">
							...
							<div class="box-content">
								<ul>
									<li><code>initPrepareParallelSignatureOperationViafirmaDesktop</code></li>
                                    <li><code>prepareSignatureOperationViafirmaDesktopAddOperationFile</code></li>
                                    <li><code>prepareSignatureOperationViafirmaDesktopFinish</code></li>
