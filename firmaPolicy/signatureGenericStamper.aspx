<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signatureGenericStamper.aspx.cs" Inherits="EjemploWebViafirmaClientDotNet.firmaPolicy.signatureGenericStamper" %>
							...
							<div class="box-content">
								...
								<form id="form1" runat="server">
				                        <asp:button id="Button2" runat="server" text="Firmar documento PDF de ejemplo" 
                                            onClick="FirmarUserPDF_POLICY_SELLO_GENERICO_Button_Click" />
                                </form>
							</div>
						</div>
					</div>
