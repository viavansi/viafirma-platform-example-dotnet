<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signatureWtihStamperAndImage.aspx.cs" Inherits="EjemploWebViafirmaClientDotNet.firmaPolicy.signature_POLICY_PDF_Sello" %>
						...
						<div class="box">
							...
							<div class="box-content">
								...
								<form id="form1" runat="server">
				                        <asp:button id="Button1" runat="server" text="Firmar un PDF con Imagen de sello" 
                                            onClick="FirmarUserPDF_POLICY_SELLO_IMAGEN_Button_Click" />
                                </form>
							</div>
						</div>
					</div>
