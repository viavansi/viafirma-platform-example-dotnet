<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="signatureDigitalizedDesktop.aspx.cs" Inherits="EjemploWebViafirmaClientDotNet.firmaUser.signatureDigitalizedDesktop" %>
			...
			<div id="content">
				...
				<div class="group">
					<div class="col width-53 append-02">
						<div class="box">
							<h3 class="box-title">Firma Digitalizada usando Viafirma Desktop por protocolo (requiere Javascript)</h3>
							
							<div class="box-content">
								<p>En este ejemplo se realiza la firma <strong>digitalizada</strong> de un documento PDF invocando a Viafirma Desktop por protocolo, requiere la intervención directa del usuario.</p>
                                
								<form id="form1" runat="server">
				                        <%  if (desktopInvocation == null) { %>
								    <p>
			                            <asp:button  ID="firmarBoton" runat="server" 
                                                Text="Iniciar proceso de firma"  OnClick="InitDigitalizedButton_Click" 
                                                Width="245px"  />
                                    </p>
                                    <% }
                                        else
