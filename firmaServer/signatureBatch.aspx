<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signatureBatch.aspx.cs" Inherits="EjemploWebViafirmaClientDotNet.firmaServer.signatureBatch" %>
							...
							<div class="box-content">
								...
								<% if ("".Equals(idFirma)) {%>
								    <form id="form2" runat="server">
				                            <asp:button id="firmarButton" runat="server" text="Firmar un lote como un archivo" 
                                                onClick="FirmarLotesServerButton_Click" Width="245px" />
                                    </form>
                                <%}%>
							</div>
						</div>
                        ...
                        <div class="box">
							...
							<div class="box-content">
                                <form id="form1" runat="server">
                                    <p>
                                        <strong>Tipo de documento:</strong> Lote de archivos<br />
