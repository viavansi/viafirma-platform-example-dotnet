<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signatureXML.aspx.cs" Inherits="EjemploWebViafirmaClientDotNet.firmaServer.signatureXML" %>
						...
						<div class="box">
							...
							<div class="box-content">
								...
								<form id="form2" runat="server">
			                        <asp:button id="firmarButton" runat="server" text="Firmar un XML con formato XAdES" 
                                        onClick="FirmarServerXMLButton_Click" Width="245px" />
                                </form>
                                 <%} %>
							</div>
						</div>
