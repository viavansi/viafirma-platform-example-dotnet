<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signaturePDFPolicy.aspx.cs" Inherits="EjemploWebViafirmaClientDotNet.firmaServer.signaturePDFPolicy" %>
							...
							<div class="box-content">
								...
								<% if ("".Equals(idFirma)) {%>
								    <form id="form2" runat="server">
				                            <asp:button id="firmarButton" runat="server" text="Firmar un PDF con PDF Signature" 
                                                onClick="FirmarServerPDFButton_Click" Width="245px" />
                                            <br />
                                            <br />
                                            <asp:button id="Button2" runat="server" text="Firmar un PDF con PDF Signature CON Timestamp" 
                                                onClick="FirmarServerPDFButton_T_Click" />
                                    </form>
                                   <%} %>
							</div>
						</div>
